...
const styles = StyleSheet.create({
  ...
  avatarContainer: { width: 85, height: 85, borderRadius: 42.5, backgroundColor: '#FFF', justifyContent: 'center', alignItems: 'center', borderWidth: 3, borderColor: '#FFF', elevation: 8 },
  avatarImage: { width: '100%', height: '100%', borderRadius: 42.5 },
  avatarGold: { borderColor: '#FFD700' },
  haloGold: { position: 'absolute', width: 95, height: 95, borderRadius: 50, borderWidth: 2, borderColor: '#FFD700', opacity: 0.5 },
  nameContainer: { flex: 1, marginLeft: 20 },
  userName: { fontSize: 13, fontWeight: '800', color: '#4e4e4e', letterSpacing: 1.5, marginBottom: 4 },
  statsRow: { flexDirection: 'row', alignItems: 'baseline' },
  userStats: { fontSize: 32, fontWeight: '900', color: '#2B5B8E' },
  textGold: { color: '#DAA520' },
  metaText: { fontSize: 16, color: '#D1D8DD', fontWeight: '600', marginLeft: 4 },
  progressSection: { width: '100%', paddingHorizontal: 5 },
  progressBarBg: { height: 14, backgroundColor: '#EBF4FF', borderRadius: 7, overflow: 'hidden' },
  progressBarFill: { height: '100%', backgroundColor: '#4CAFFF', borderRadius: 7 },
  progressBarGold: { backgroundColor: '#FFD700' },
  progressPercent: { fontSize: 12, fontWeight: '900', color: '#BDC3C7', marginTop: 8, textAlign: 'center', letterSpacing: 1 },
